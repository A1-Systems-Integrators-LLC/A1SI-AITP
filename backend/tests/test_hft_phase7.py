...
class TestHftRunnerCLI:
    ...
    def test_convert_command(self):
        ...
        with patch.object(hft_runner, "convert_ohlcv_to_hft_ticks") as mock_convert:
            ...
            hft_runner.cli_main(["convert", "--symbol", "ETH/USDT", "--timeframe", "1d", "--exchange", "kraken"])
    ...
    def test_list_strategies_command(self, capsys):
        ...
        with patch.object(hft_runner, "list_hft_strategies", return_value=["MarketMaker", "GridTrader"]):
...
class TestBaseStrategyUncoveredLines:
    ...
    def test_get_trades_df_empty_when_all_same_side(self):
        ...
        tick = {"timestamp": 1_700_000_000_000_000_000, "price": 100.0, "volume": 0.01, "side": "buy"}
...
class TestMarketMakerDrawdownHaltReturn:
    ...
    def test_on_tick_returns_early_after_drawdown_halt(self):
        ...
        strategy = HFTMarketMaker(config={
        ...
        tick = {"timestamp": 1_700_000_000_000_000_000, "price": 100.0, "volume": 0.01, "side": "sell"}
