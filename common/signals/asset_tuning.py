...
ASSET_CONFIGS: dict[str, AssetClassConfig] = {
    "crypto": AssetClassConfig(
        conviction_threshold=55,  # Raised from 40 — see profitability audit
    ...
    "equity": AssetClassConfig(
        conviction_threshold=60,  # Raised from 50 — see profitability audit
    ...
    "forex": AssetClassConfig(
        conviction_threshold=55,  # Raised from 45 — see profitability audit
